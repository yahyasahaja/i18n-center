    ...
    "paths": {
        ...
        "/translations/bulk": {
            "get": {
                ...
                "description": "Get translations for multiple components at once. Uses Redis cache efficiently - checks cache first, then database for missing ones. Can use either component_ids or component_codes.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
    ...
    "definitions": {
        ...
        "models.TranslationVersion": {
            ...
            "properties": {
                ...
                "version": {
                    "description": "1 = before save, 2 = after save",
                    "type": "integer"
                }
            }
        },
